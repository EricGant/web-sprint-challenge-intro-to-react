...
React is used for building interfaces for single-page applications. It also allows developers to build complex UI's that have components that change frequently over time. 

1. Describe component state.
Component state is an object that holds information that may change over the lifetime of the component. 

1. Describe props.
Props are properties, and are used for passing data from one component to another. props are passed from parent to child.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects are anything that affects something outside of the scope of the current function. You sync them using async and wait.